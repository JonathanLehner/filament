...
class MainActivity : Activity(), ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    private var StreamHelper: StreamHelper? = null
            ...
            if (uiHelper.isReadyToRender) {
                ...
                if (renderer.beginFrame(swapChain!!)) {
                    ...
                    if (StreamHelper == null) {
                        ...
                        StreamHelper = StreamHelper(this@MainActivity, engine, materialInstance, windowManager.defaultDisplay, externalTextureID).apply {
                            openCamera()
                        }
                    }
    ...
    override fun onRequestPermissionsResult(requestCode: Int, permissions: Array<String>, grantResults: IntArray) {
        if (!StreamHelper!!.onRequestPermissionsResult(requestCode, grantResults)) {
